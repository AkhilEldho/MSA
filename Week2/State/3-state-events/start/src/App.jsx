...
function App() {
    ...
    function ingredientClick(index) {
        //creating copy of object and updating object
    ...
    //code that runs every time ingredients have a change 
    //code used when changes are made
    useEffect(() => {
    ...
    return (
        <article>
            ...
            <IngredientList ingredients={recipe.ingredients} ingredientSet={ ingredientClick } />
